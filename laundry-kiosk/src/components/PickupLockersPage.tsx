...
import { BackgroundBubbles } from '../components/BackgroundBubbles'; // Import component
...
export function PickupLockersPage({ lockers, onSelectLocker, onBack }: PickupLockersPageProps) {
  ...
  return (
    <div className="lockers-page" style={{ 
      ...
      position: 'relative', // Ensure bubbles stay inside
      ...
      {/* 2. Content Layer - Using zIndex to ensure buttons stay clickable */}
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <button 
          ...
          style={{ top: '12px', right: '12px', zIndex: 10 }} // High z-index for the button
        >
